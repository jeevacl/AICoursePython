...
# PretrainedTransformerModel starts here
import transformers
...
print("\n" + "="*30 + "\n")
print("Sentence 1: " + sentence_1)
print("Sentiment Score: " + str(sentiment_pipeline(sentence_1)))

print("\n" + "="*30 + "\n")
print("Sentence 2: " + sentence_2)
print("Sentiment Score: " + str(sentiment_pipeline(sentence_2)))

print("\n" + "="*30 + "\n")
print("Sentence 3: " + sentence_3)
print("Sentiment Score: " + str(sentiment_pipeline(sentence_3)))

print("\n" + "="*30 + "\n")
print("Sentence 4: " + sentence_4)
print("Sentiment Score: " + str(sentiment_pipeline(sentence_4)))

model_name = "finiteautomata/bertweet-base-sentiment-analysis"
specific_model = pipeline("sentiment-analysis",model=model_name)


print("\n" + "="*30 + "\n")
print("specific model")
print("Sentence 1: " + sentence_1)
print("Sentiment Score: " + str(specific_model(sentence_1)))

print("\n" + "="*30 + "\n")
print("Sentence 2: " + sentence_2)
print("Sentiment Score: " + str(specific_model(sentence_2)))

print("\n" + "="*30 + "\n")
print("Sentence 3: " + sentence_3)
print("Sentiment Score: " + str(specific_model(sentence_3)))

print("\n" + "="*30 + "\n")
print("Sentence 4: " + sentence_4)
print("Sentiment Score: " + str(specific_model(sentence_4)))
